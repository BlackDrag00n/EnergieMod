...
public class ItemCafeBouteille extends Item
{
	public float EnergieGagnerGourde = 25f; // Variable qui définie de combien on remonte l'energie
	
	public ItemCafeBouteille()
	{
		super();
	...
	{
		this.itemIcon = iconregister.registerIcon(PyKEnergieMod.MODID + ":cafe_bouteille");
	}
